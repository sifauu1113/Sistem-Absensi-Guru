...
class Karyawan_model extends CI_Model
{
    ...
    {
        $sql = "SELECT a.id_karyawan,a.nip,a.nama_karyawan,b.nama_jabatan,c.nama_shift,a.gedung_id
    ...
    {
        $sql = "SELECT a.id_karyawan,a.nip,a.nama_karyawan,b.nama_jabatan,d.nama_shift,c.nama_gedung
    ...
    function getData()
    {
        $this->datatables->select('a.id,a.id_karyawan,a.nip,a.nama_karyawan,b.nama_jabatan,d.nama_shift,c.nama_gedung')
            ->from('karyawan as a,jabatan as b,gedung as c,shift as d')
            ->where('b.id_jabatan=a.jabatan')
