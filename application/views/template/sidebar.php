        ...
        <ul class="sidebar-menu">
            <li>
                <a href="<?php echo base_url('dashboard') ?>">
                    <i class="fa fa-laptop"></i> <span>Halaman Utama</span>
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview active">
                ...
                <ul class="treeview-menu menu-open" style="display: block;">
                    <li><a href="<?php echo base_url('karyawan') ?>"><i class="fa fa-user"></i> <span>DATA Guru</span></a></li>
                    <li><a href="<?php echo base_url('jabatan') ?>"><i class="fa fa-briefcase"></i> <span>DATA JABATAN</span></a></li>
                    <li><a href="<?php echo base_url('shift') ?>"><i class="fa fa-retweet"></i> <span>DATA Mata Pelajaran</span></a></li>
                    <li><a href="<?php echo base_url('lokasi') ?>"><i class="fa fa-location-arrow"></i> <span>DATA Jurusan</span></a></li>
                </ul>
            </li>
            <li>
