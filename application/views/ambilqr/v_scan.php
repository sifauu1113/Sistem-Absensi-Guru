    ...
    <div id="print-area">
        ...
        <div class="box box-widget widget-user-2">
            ...
            <div class="widget-user-header bg-blue">
                ...
                <!-- /.widget-user-image -->
                <h3 class="widget-user-username"><?php echo $nip ?></h3>
            ...
            <div class="box-footer no-padding">
                <ul class="nav nav-stacked">
                    <li><a href="#">Jabatan : <?php echo $nama_jabatan; ?> </a></li>
                    <li><a href="#">Mata Pelajaran : <?php echo $nama_shift; ?> </a></li>
                    <li><a href="#">Kode Jurusan : <?php echo $nama_gedung; ?> </a></li>
                </ul>
            </div>
        </div>
    </div>
